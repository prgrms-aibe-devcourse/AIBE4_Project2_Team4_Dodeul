...
public class ApiResponse<T> {
    ...
    /**
     * [성공 응답 2] - 상세 메시지 커스텀 (Overloading) 예: "사용 가능한 닉네임입니다.", "상담 신청이 완료되었습니다." 등 성공 상황에 대해 더
     * 구체적인 안내가 필요할 때 사용
     *
     * @param successCode 성공 코드 Enum
     * @param data 반환할 데이터
    ...
    /**
     * [실패 응답 2] - 상세 메시지 커스텀 (Overloading) 예: "이미 신청한 상담입니다.", "멘토 모집이 마감되었습니다." 등 같은 에러 코드라도 상황에
